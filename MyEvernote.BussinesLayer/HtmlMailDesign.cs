...
namespace MyEvernote.BussinesLayer
{
    ...
    {
        public static string TemplateActivation1(string Guid, string ControllerName, string ActionName, bool securedDomain = false, string domainName = "", bool hasArea = false, bool guidIsID = false, string GuidSendingParameter = "", string areaName = "", string Username = "")
        {
            string url;
